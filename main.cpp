...
//Методите print и get_print могат да бъдат направени по - добре; 
//В класа Cart метода за добавяне не работи правилно.
//Полиморфизма не работи правилнол
//Грешки при използването на итератор
